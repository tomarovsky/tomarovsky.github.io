...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      ...
      {% if link.summary %}
      <div class="abstract tex2jax_process" style="margin-top: 10px; font-size: 1.05em; line-height: 1.5; color: #666; font-style: italic;">{{ link.summary | markdownify | remove: '<p>' | remove: '</p>' }}{% if link.page %} Visit the <a href="{{ link.page }}" target="_blank" style="color: #39c; text-decoration: none;">project page</a>.{% endif %}{% if link.blog %} Read more about this work in our <a href="{{ link.blog }}" target="_blank" style="color: #39c; text-decoration: none;">blog post</a>{% if link.blog2 %} and <a href="{{ link.blog2 }}" target="_blank" style="color: #39c; text-decoration: none;">another blog post</a>{% endif %}.{% endif %} — <a href="{{ link.pdf }}" target="_blank" style="color: #39c; font-weight: bold; text-decoration: none;">{{ link.conference }}</a></div>
      {% endif %}
    <div class="links">
      {% if link.code %}
